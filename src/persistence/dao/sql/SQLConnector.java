...
<<<<<<< HEAD
            instance = new SQLConnector("root", "", "localhost", 3306, "dpog7");
=======
            instance = new SQLConnector(config.getUsername(), config.getPassword(), config.getIp(), config.getConnectionPort(), config.getName());
            //instance = new SQLConnector("root", "", "localhost", 3306, "dpog7");
